(function ($) {
	...
	$(document).on(
		...
		function (e) {
			$(this)
				.parentsUntil('.cwp-primary-menu', 'li')
				.addClass('cwp-open-submenu');
		}
	);
	$(document).on(
		'blur',
	...
	$(document).on(
		...
		function (e) {
			...
			$(this)
				.parentsUntil('.cwp-primary-menu', 'li .sub-menu')
				.addClass('open');
		}
	);
	$(document).on(
		...
		'.cwp-header-menu-sidebar .cwp-primary-menu-wrapper a',
		function (e) {
			$('.cwp-header-menu-sidebar .cwp-primary-menu li .sub-menu').removeClass(
				'open'
			);
		}
	);
	...
	$(document).on('keydown', '#cwp-dropdown-search-form-wrapper', function (e) {
		let dropdownSearch = document.getElementById(
